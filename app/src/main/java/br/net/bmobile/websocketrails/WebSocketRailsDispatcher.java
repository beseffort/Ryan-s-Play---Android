...
public class WebSocketRailsDispatcher {
    ...
    public void trigger(String eventName, Object data, WebSocketRailsDataCallback success, WebSocketRailsDataCallback failure) {
        ...
        List<Object> frame = new ArrayList<Object>();
        frame.add(eventName);
Log.e("trigger in ", "web socket rails dispatcher..." + data.toString() + "event name " + eventName);
        if(data instanceof Map<?, ?>) {
            frame.add(data);
            Log.e("trigger in ", "web socket rails dispatcher...inside if");
        }
        else {
            Map<String, Object> payload = new HashMap<String, Object>();
            payload.put("data", data);
            frame.add(payload);
            Log.e("trigger in ", "web socket rails dispatcher...inside else payload--->" + payload.toString());
        }
    ...
    public void trigger(String eventName, Object data) {
        ...
        Log.e("trigger in","trigger fn websocket.sent");
